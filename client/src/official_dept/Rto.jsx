...
const RtoDashboard = () => {
  ...
  const analyzePriorityLocally = (grievance) => {
    ...
    const highPriorityKeywords = [
      ...
      'accident', 'collision', 'hit and run', 'drunk driving', 'road safety',
      'license fraud', 'illegal registration'
    ];

    // Keywords indicating medium priority
    const mediumPriorityKeywords = [
      'important', 'moderate', 'renewal', 'transfer', 'registration',
      'license issue', 'permit', 'fitness certificate', 'vehicle inspection'
    ];
    ...
    if (hasHighPriority) {
      return {
        priority: 'High',
        explanation: 'This grievance requires immediate attention due to potential safety concerns or legal violations.',
        impactAssessment: 'High impact on road safety or regulatory compliance. Immediate action required.',
      ...
      return {
        ...
        impactAssessment: 'Moderate impact on public services. Action required within standard timeframe.',
      ...
      return {
        ...
        impactAssessment: 'Limited impact on services. Can be addressed through regular processing.',
